...
class PatternsSpec : StringSpec({
    ...
    "A stripe pattern is constant in y" {
        ...
        pattern.stripeAt(point(0.0, 0.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 1.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 2.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 3.0, 0.0)) shouldBe Color.WHITE
    }

    "A stripe pattern is constant in z" {
        val pattern = StripePattern(Color.WHITE, Color.BLACK)
        pattern.stripeAt(point(0.0, 0.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 0.0, 1.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 0.0, 2.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.0, 0.0, 3.0)) shouldBe Color.WHITE
    }

    "A stripe pattern alternates in x" {
        val pattern = StripePattern(Color.WHITE, Color.BLACK)
        pattern.stripeAt(point(0.0, 0.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(0.9, 0.0, 0.0)) shouldBe Color.WHITE
        pattern.stripeAt(point(1.0, 0.0, 0.0)) shouldBe Color.BLACK
        pattern.stripeAt(point(-0.1, 0.0, 0.0)) shouldBe Color.BLACK
        pattern.stripeAt(point(-1.0, 0.0, 0.0)) shouldBe Color.BLACK
        pattern.stripeAt(point(-1.1, 0.0, 0.0)) shouldBe Color.WHITE
    }
    ...
    "Stripes with an object transformation" {
        ...
        obj.material.pattern!!.stripeAtObject(obj, point(1.5, 0.0, 0.0)) shouldBe Color.WHITE
    }
    ...
    "Stripes with an pattern and object transformation" {
        ...
        obj.material.pattern!!.stripeAtObject(obj, point(2.5, 0.0, 0.0)) shouldBe Color.WHITE
    }
})